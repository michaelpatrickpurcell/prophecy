...
%		\raggedright{\Large{{\textcolor{black}{Michael Purcell \hfill Version 0.2}}}}
		\Large{{\textcolor{black}{Draft Version 0.2}}}\\
...
\thispagestyle{empty}
\enlargethispage{5\baselineskip} % Move the bottom line down a bit
...
{\bfseries Contact} - \href{mailto:prophecy.ttrpg@gmail.com}{prophecy.ttrpg@gmail.com}\\
