...
\subsection*{Dead Man's Switch  \setmainfont{URWClassico} - By Brett Witty} \label{subsection:dead-mans-switch}
...
\subsection*{R'lyehian Rhapsody \setmainfont{URWClassico} - By David McKenzie} \label{subsection:rlyehian-rhapsody}
The time is nigh.
Soon the planets will be in alignment and we can harness their celestial power.
With just a gentle push, we can release the Great Old One from his prison.
