...
\smallskip
\begin{center}
\begin{tikzpicture}[every path/.style={ultra thick}, every node/.style={draw, rounded corners=2mm, minimum width=3cm}]
...
\draw[ultra thick, -{Latex}] (s11) -- (s1);
\draw[ultra thick, -{Latex}] (s12) -- (s1);
\draw[ultra thick, -{Latex}] (s13) -- (s1);
\draw[ultra thick,-{Latex}] (s121) -- (-2, 6) -- (s12);
\draw[ultra thick,-{Latex}] (s122) -- (s12);
\draw[ultra thick,-{Latex}] (s131) -- (s13);
\draw[ultra thick,-{Latex}] (s1221) -- (s122);
\end{tikzpicture}
\end{center}
